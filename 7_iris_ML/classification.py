...
# ------- New example with neural network --------

neural = MLPClassifier(solver='lbfgs', hidden_layer_sizes=(3, 2))

nn_model = neural.fit(X, y)

nn_pred = nn_model.predict(X_test)

print(f"Neural network accuracy is {accuracy_score(y_test, nn_pred)}")